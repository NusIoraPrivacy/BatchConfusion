...
if __name__ == "__main__":
    ...
    tokenizer, model = load_emb_model(args.model_name)

    for sample in tqdm(data):
        question = sample["question"]
        # print(question)
        question = custext_priv(tokenizer, model, question, args.model_name, args.top_k, args.epsilon, args)
        sample["question"] = question
    del model
    
    log_root = f"{args.root_path}/result/{args.data_name}/logs/dp/custext"
