...
def parse_args():
    ...
    parser.add_argument("--max_k", type=float, default=100)
...
if __name__ == "__main__":
    ...
    for sample in tqdm(data):
        try:
            ...
            priv_attrs, priv_cpr_attrs, fake_attrs = sample["filtered private attributes question"], sample["filtered private attributes compression"], sample["fake attributes compression"]
            fake_key = "fake attributes compression"
