...
#             python -m attack.atr_attack --in_file_name "fake_cattr_random_${model_short_name}_${sample_mul}.json" --model_name $dis_model --fake_key "fake attributes text" --priv_key "filtered private attributes text" --query_key text --data_name twitter --sample_top_k 0 --epochs 20 --use_emb
#         done
#     done
# done