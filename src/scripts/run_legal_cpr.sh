...
do
    ...
    do
        ...
        python -m train_local.generator_v2 --out_file_name "fake_cattr_random_$top_k.json" --top_k_ratio $top_k --fake_key "fake attributes compression" --priv_key "filtered private attributes compression" --query_key compression --data_name legal-qa-v1 --in_file_name compress_fake_cattr_multi_4omini_4.json --model_name meta-llama/Llama-3.2-1B
