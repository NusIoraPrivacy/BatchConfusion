...
do
    ...
    do
        ...
        echo "Generate fake combinations for legal compression under multiplier $sample_mul using with model $model_short_name"
...
do
    ...
    do
        model_short_name="${model##*/}"
        echo "Generate fake combinations for medical compression under multiplier $sample_mul using with model $model_short_name"
...
do
    ...
    do
        model_short_name="${model##*/}"
        echo "Generate fake combinations for mmlu compression under multiplier $sample_mul using with model $model_short_name"
