...
#     python -m train_local.train_compress --model_name $model --data_name legal-qa-v1 --in_file_name compress_fake_cattr_multi_4omini_4.json --query_key question --cpr_key compression --train_batch_size 2 --test_batch_size 4
# done
...
do
    ...
    do
        ...
        python -m evaluation.utility_oa --data_name legal-qa-v1 --local_model $model_short_name --local_epoch $epoch --query_online_model gpt-4o --remote_cpr compress_fake_cattr_multi_4omini_4.json --answer_key response --query_key question --cpr_key "predicted compression"
    done
done