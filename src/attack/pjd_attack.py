...
priv_keys = ["filtered private attributes question", "filtered private attributes compression"]
query_keys = ["question", "compression"]
models = ["FacebookAI/roberta-large", "Qwen/Qwen2.5-1.5B-Instruct", "Qwen/Qwen2.5-0.5B-Instruct", "meta-llama/Llama-3.2-1B"]
...
if __name__ == "__main__":
    ...
    train_dataset = PJDDataset(train_data, tokenizer, args.max_word)
    test_dataset = PJDDataset(test_data, tokenizer, args.max_word)
    # obtain dataloader
